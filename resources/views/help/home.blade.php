...
<div id="app">
    ...
    <div class="jumbotron bg-info text-white helpcenter-home">
        <div class="container">
            <h1 style="font-size: 4em">How can we help you?</h1>
                    ...
                    <div class="card-body">
                        <form action="">
                            <div class="form-group">
                                ...
                                <input id="name" class="form-control" type="text" readonly name="name" value="{{ Auth::user()->name }}">
                            </div>

                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" class="form-control" type="text" readonly name="email" value="{{ Auth::user()->email }}">
                            </div>
                        </form>
                    </div>
                </div>
